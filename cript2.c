...
int main(int argc, char const *argv[])
{
    ...
    int m[n],cod[n], decod[n], opc, a,b,c,d;
    printf("\t------Criptografia Guizinho 2.0------\n");
    printf("[1]Codificar\n[2]Decodificar\n");
    scanf("%d",&opc);
    ...
    if (opc == 1)
    {
        ...
        scanf(" %[^\n]s",msg);
        printf("Digite o A e B da função de criptografia:(An + B)\n");
        scanf("%d",&a);
        scanf("%d",&b);
        //PRÉ CODIFICAÇÃO
        int i = 0;
        ...
        scanf(" %[^\n]s",codletras);
        printf("Digite o C e D da função de decodificação:(Cn + D)\n");
        scanf("%d",&c);
        scanf("%d",&d);
        i = 0;
        while (codletras[i]!='\0')
